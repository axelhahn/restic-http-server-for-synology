<html>
<div class="hero">
  <h2>Restic Http Server<br>on Synology NAS</h2>
  A set of bash scripts to install and run a rest http server on a Synology NAS<br>
</div>
</html>
...
--> for users with installatins before Sep 2026 see hints in the [upgrade](90_Upgrade.md) page.
